...
class productosTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DBinv.Map.productosTableMap';
     ...
     */
    const OM_CLASS = '\\DBinv\\productos';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'DBinv.productos';
     ...
     */
    const COL_ID = 'productos.id';

    /**
     * the column name for the cod field
     */
    const COL_COD = 'productos.cod';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Cod', 'Nombre', ),
        self::TYPE_CAMELNAME     => array('id', 'cod', 'nombre', ),
        self::TYPE_COLNAME       => array(productosTableMap::COL_ID, productosTableMap::COL_COD, productosTableMap::COL_NOMBRE, ),
        self::TYPE_FIELDNAME     => array('id', 'cod', 'nombre', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Cod' => 1, 'Nombre' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'cod' => 1, 'nombre' => 2, ),
        self::TYPE_COLNAME       => array(productosTableMap::COL_ID => 0, productosTableMap::COL_COD => 1, productosTableMap::COL_NOMBRE => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'cod' => 1, 'nombre' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DBinv\\productos');
        $this->setPackage('DBinv');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('cod', 'Cod', 'INTEGER', true, null, null);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(productosTableMap::COL_ID);
            $criteria->addSelectColumn(productosTableMap::COL_COD);
            $criteria->addSelectColumn(productosTableMap::COL_NOMBRE);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.cod');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DBinv\productos) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(productosTableMap::DATABASE_NAME);
            $criteria->add(productosTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(productosTableMap::COL_ID) && $criteria->keyContainsValue(productosTableMap::COL_ID) ) {
